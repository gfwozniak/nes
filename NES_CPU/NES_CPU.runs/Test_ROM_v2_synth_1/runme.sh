...
HD_PWD='C:/Users/George/Desktop/NES/nes/NES_CPU/NES_CPU.runs/Test_ROM_v2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_ROM_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_ROM_v2.tcl
