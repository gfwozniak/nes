...
HD_PWD='C:/Users/George/Desktop/NES/nes/NES_CPU/NES_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_v2.tcl
