...
#
# Generated by export_simulation on Mon Dec 04 19:04:52 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './Test_ROM_v2.sh' script.

./Test_ROM_v2.sh -reset_run
...
./Test_ROM_v2.sh -noclean_files

For more information on the script, please type './Test_ROM_v2.sh -help'.
